...
if (quater == 2) Console.WriteLine($"Четверть №{quater} обладает диапозоном X(0, {max}); Y(0, {min})");
if (quater == 3) Console.WriteLine($"Четверть №{quater} обладает диапозоном X(0, {min}); Y(0, {min})");
if (quater == 4) Console.WriteLine($"Четверть №{quater} обладает диапозоном X(0, {min}); Y(0, {max})");